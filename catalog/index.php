...
$obSections = CIBlockSection::GetList([ 'sort'=> 'asc', 'id'=>'asc'], $filterSections);
while ($arSections = $obSections->GetNext()) {
    if ($arSections['RIGHT_MARGIN'] - $arSections['LEFT_MARGIN'] < 2) {
        $sections[] = ['ID'=> $arSections['ID'], 'NAME' => $arSections['NAME']];
...
?>
	...
	array(
		...
		"CACHE_TIME" => "3600",
		"CACHE_TYPE" => "A",
		"COMPONENT_TEMPLATE" => "viewed_catalog",
		"CONVERT_CURRENCY" => "N",
		"DEPTH" => "2",
		"DISPLAY_COMPARE" => "N",
